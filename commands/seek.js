...
module.exports = {
  name: "seek",
  description: "Passer à l'horodatage",
  permissions: "0x0000000000000800",
  options: [{
    name: "time",
    description: "Saisir l'horodatage",
  ...
  run: async (client, interaction) => {
    try {
      ...
      queue.seek(position)
      interaction.reply({ content: `<:PRO_RIGHT:1221477527449632779> **Vous emmener dans un voyage dans le temps jusqu'à l'horodatage spécifié.**`}).catch(e => { })
